...
fn the_kinds_add_up_to_the_pool() {
    ...
    // Enriching Energy, Telepathic Psychic Energy, and Spiky Energy
    // (two prints), taking this from 21 to 16.
    assert_eq!(count(Refusal::IsASpecialEnergy), 16, "every Energy card");
    assert_eq!(
