...
fn the_kinds_add_up_to_the_pool() {
    ...
    // second batch of Trainers takes 20 more: Cyrano, Buddy-Buddy Poffin,
    // Ultra Ball, Special Red Card, Energy Switch, Hilda, and Dawn.
    assert_eq!(trainers, 403, "the Trainers still refused, by kind");
