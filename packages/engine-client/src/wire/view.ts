// The shape `Game.view()` returns as JSON — the "Wire" encoding of the
// engine's own Masked view, from `WireView` in
// `crates/sim-wasm/src/lib.rs`. See the "Wire" glossary entry.
